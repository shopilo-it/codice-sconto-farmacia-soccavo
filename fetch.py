#!/usr/bin/env python3
"""
Recupero codici sconto Farmacia Soccavo da shopilo.it
Sursa: https://shopilo.it/negozi/farmaciasoccavo.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/farmaciasoccavo.it"
STORE_NAME = "Farmacia Soccavo"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Farmacia Soccavo da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-farmacia-soccavo)"
    }
    try:
